...
row = 1643 , colum = 6.
the row it's about the restaurant address (more information about it) column (address, city, state, zip, longitude, latitude)
...
row = 909 , colum = 6.
the row it's about the hotels address (more information about it) column (address, city, state, zip, longitude, latitude)
...
4.  Which states have the most and fewest Denny's locations? What about La Quinta? Is this surprising? Why or why not?
 Denny's     the most = CA and the fewset = DE
